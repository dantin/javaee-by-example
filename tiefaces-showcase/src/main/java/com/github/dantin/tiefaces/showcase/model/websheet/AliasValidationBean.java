...
import com.github.dantin.tiefaces.showcase.model.datademo.Employee;
...
*/
    ...
    private String optimizedWayByCallingServiceForAllFields(
            Map<String, Object> dataContext,
            String dataField,
            String nestedDataFullName,
            String sheetName,
    ...
    private Map<String, String> callService(List<String> list, Map<String, Object> dataContext) {
        ...
        for (String field : list) {
            switch (field) {
                ...
                case "employee.bonus":
                    ...
                    } else if (employee.getBonus() > 0.5d) {
                ...
                case "employee.total":
                    ...
                    } else if (employee.getTotal() > 3000d) {
